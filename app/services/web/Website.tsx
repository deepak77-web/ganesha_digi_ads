...
const reasons= [
    { img:"/website.gif",
      ...
      description:"Professional websites for your brand"   
    },
    { img:"/shopping.gif",
      title:"Shopify / WooCommerce Store Setup ",
...
export default function Website(){
    ...
    return(
        <div className=" flex justify-center ">
            ...
            {/* Left part */}
            <img src="/website.jpg" alt="" className="w-auto md:w-[440px] h-auto lg:w-[540px] lg:h-[572px]  rounded-4xl "/>
            ...
            <div className="flex flex-col w-full md:max-w-[540px] h-[496px] lg:h-auto gap-3 sm:h-auto sm:gap-4 md:h-auto md:gap-5 lg:justify-between">
                ...
                <h2 className="w-full text-[32px] lg:text-[46px] font-semibold leading-none text-center ">Website & E-commerce Services</h2>
                <h1 className="w-full font-semibold text-[#6430c0] text-[24px] leading-tight text-center "> 
                    <Typewriter options={{ 
                        strings: [ "Online Presence Se Sales Tak, Humara System"],
                        autoStart: true,
                        loop: true,
                        delay: 40,
                        deleteSpeed: 30,
