...
const reasons= [
    ...
    { img:"/shopping.gif",
      title:"Politicians Election Branding ",
      description:"Ready-to-sell online stores"   
    },
]
...
export default function Branding(){
    ...
    return(
        <div className=" flex justify-center ">
            ...
            {/* Left part */}
            <img src="/brand.jpg" alt="" className="w-auto md:w-[440px] h-auto lg:w-[540px] lg:h-[572px]  rounded-4xl "/>
            ...
            <div className="flex flex-col w-full md:max-w-[540px] h-[496px] lg:h-auto gap-3 sm:h-auto sm:gap-4 md:h-auto md:gap-5 lg:justify-between">
                ...
                <h2 className="w-full text-[32px] lg:text-[46px] font-semibold leading-none text-center ">Branding & Creative Services</h2>
